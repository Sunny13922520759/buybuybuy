    ...
    <div>
      ...
      <el-carousel-item v-for="item in sliderlist" :key="item.id">
       ...
       <a href="#">
        ...
        <!-- 手机数码分类商品 -->
        <div class="section" v-for="item in cateProductList" :key="item.level1cateid">
            <div class="main-tit">
...
export default {
  ...
  created() {
    //获取头部的数据
    this.$axios("site/goods/gettopdata/goods").then(response => {
    ...
    //获取商品列表数据
    this.$axios("site/goods/getgoodsgroup").then(response => {
      // console.log(response);
      this.cateProductList = response.data.message;
    });
  }
};
</script>
